      ...
      <div className="row g-0 align-items-center flex-column-reverse flex-md-row">
        <div className="col-md-6 p-5 mt-lg-5">
          <h1 className="display-5 animated fadeIn mb-4" style={{ fontWeight: 'bold' }}>
            Temukan <span style={{ color: '#0D9276' }}>Keindahan</span> Dalam Setiap Frame
          </h1>
          <h6 className="animated fadeIn mb-4 pb-2">
            Jelajahi koleksi penuh makna dan saksikan momen-momen indah yang terabadikan dalam lensa kami
          </h6>
        </div>
